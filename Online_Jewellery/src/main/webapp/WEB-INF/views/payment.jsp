...
<div class="container" style="border:0.5px solid gray">
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    <form role="form" id="payment-form" method="POST" action="bill">
                        <div class="row">
                            <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-7 col-md-7">
                                <div class="form-group">
                                    <label for="cardExpiry"></span><span class="visible-xs-inline">EXP</span> DATE</label>
                                    <input 
                                        type="tel" 
                                        class="form-control" 
                                        name="cardExpiry"
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="subscribe btn btn-success btn-lg btn-block" type="submit">Payment Process </button>
                            </div>
                        </div>
        ...
        <div class="<div class=col-xs-12 col-md-8" style="font-size: 12pt; line-height: 2em;">
            <p><h1>Features:</h1>
            <p class="">Rs.${GrandTotal} Payble Amount 
                <ul>
